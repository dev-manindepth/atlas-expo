...
This repository is the Expo build of the app, targeting iOS first.
...
We'll need Node and an iOS simulator (Xcode) set up first.
...
From the Expo dev server, press `i` to open the app on the iOS simulator.
